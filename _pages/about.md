...
Previously an Assistant Professor at VIT Vellore (2020–2025), I earned my Ph.D. from BITS Pilani, Hyderabad. I have published {{ site.data.research_areas.research_stats.total_publications }}+ peer-reviewed papers with {{ site.data.research_areas.research_stats.total_citations }}+ citations (h-index {{ site.data.research_areas.research_stats.h_index }}, i10-index {{ site.data.research_areas.research_stats.i10_index }}) in venues including *Internet of Things*, *Cluster Computing*, *IEEE Access*, and *Scientific Reports*.
